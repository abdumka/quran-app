...
void main() async {
  ...
  if (res.statusCode == 200) {
    ...
    print('Madinah Page 100 starts with: Surah ' + ayahs.first['surah']['number'].toString() + ' Ayah ' + ayahs.first['numberInSurah'].toString());
    print('Madinah Page 100 ends with: Surah ' + ayahs.last['surah']['number'].toString() + ' Ayah ' + ayahs.last['numberInSurah'].toString());
    ...
    for (int i = 0; i < flattened.length; i++) {
      ...
      if (pageObj['page'] == 100) {
        ...
        print('JSON Page 100 starts with: Surah ' + ayahsJson.first['surah'].toString() + ' Ayah ' + ayahsJson.first['ayah'].toString());
        print('JSON Page 100 ends with: Surah ' + ayahsJson.last['surah'].toString() + ' Ayah ' + ayahsJson.last['ayah'].toString());
        break;
      }
    }
  } else {
