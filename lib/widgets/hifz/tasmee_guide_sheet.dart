...
const List<_Item> _items = [
  _Item(null, 'النقطة', 'خضراء: التطبيق يسمعك، وتكبر مع صوتك. حمراء: خطأ ينتظر التصويب.'),
  _Item(Icons.lightbulb_outline_rounded, 'كلمة', 'تكشف الكلمة التالية (أو الكلمة المتوقَّف عندها) وتُحسب ملاحظة.'),
  _Item(Icons.visibility_rounded, 'الآية', 'تكشف الآية الحالية كاملة وتنتقل بك إلى التي بعدها.'),
  _Item(Icons.replay_circle_filled_rounded, 'أعد الآية', 'تُخفي الآية الحالية من جديد لتقرأها من أولها.'),
  _Item(Icons.skip_next_rounded, 'تخطَّ', 'تتجاوز الآية الحالية إلى التي بعدها.'),
  ...
  _Item(Icons.keyboard_arrow_down_rounded, 'إخفاء', 'يطوي الشريط إلى نقطة صغيرة؛ اضغطها ليعود.'),
];
