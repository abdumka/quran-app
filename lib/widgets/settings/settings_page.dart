...
class _SettingsPageState extends State<SettingsPage> {
  ...
  String get _tafsirInfoText =>
      'اختر التفسير الافتراضي. التفاسير الكبيرة (ابن كثير، الطبري، القرطبي، زاد المسير) تُنزَّل صفحاتها من الإنترنت عند فتحها وتُحفظ للقراءة لاحقًا بدون إنترنت. يمكنك أيضًا تبديل التفسير من أعلى نافذة التفسير.';

  String get _tafsirDownloadInfoText =>
      'نزّل التفسير المختار كاملًا لقراءته بدون إنترنت. التفاسير المدمجة (السعدي، الميسّر، الجلالين) متوفرة دائمًا بدون تنزيل، أما الكبيرة (ابن كثير، الطبري، القرطبي، زاد المسير) فتُحمَّل صفحاتها هنا. يمكنك حذف ما نزّلته من إدارة الملفات المحمّلة.';
