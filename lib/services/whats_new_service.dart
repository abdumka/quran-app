...
class WhatsNewService {
  ...
  static const List<String> currentReleaseChanges = [
    'جديد: «التسميع» في «أدوات الحفظ». تُغطّى كلمات الصفحة وتقرأ من حفظك، فتنكشف كل كلمة صحيحة، مع تنبيه عند الخطأ وتقرير لكل صفحة. يعمل على جهازك دون إنترنت بعد تنزيل النموذج مرة واحدة، ويظهر شرحه عند أول استخدام.',
    'يعمل التطبيق الآن على أجهزة أندرويد تي في: المصحف والفهرس والتلاوة والتفسير، كلها بجهاز التحكم عن بعد، مع تنزيل السور للاستماع دون إنترنت.',
    'التفسير: اضغط مطوّلًا على أي آية ثم اختر «تفسير الآية»، أو «إضافة علامة هنا».',
    'تظليل الآية التي تُتلى أثناء التلاوة، وخيارات جديدة في تكرار المقطع.',
    'تذكير «سورة الكهف» كل جمعة، وإشعارات بالإضافات الجديدة، ويمكن إيقافهما.',
    'إصلاح انقطاع الصوت بين الآيات عند الشيخ القريو والشيخ أبوسنينة.',
  ];
