...
class WhatsNewService {
  ...
  static const List<String> currentReleaseChanges = [
    'إضافة تلاوة الشيخ علي بن عبدالرحمن الحذيفي برواية قالون، لتصبح 4 تلاوات.',
    'إضافة «تكرار مقطع» في خيارات التلاوة: اختر السورة ونطاق الآيات وعدد التكرار.',
    'إضافة تفاسير جديدة (ابن كثير، الطبري، القرطبي، وزاد المسير) لتصبح 7 تفاسير.',
    'إمكانية تخصيص لون خلفية صفحات المصحف.',
    'تنظيم الإعدادات في مجموعات لتسهيل الوصول إليها.',
    'تحسينات في إدارة التحميلات.',
    'إمكانية تصدير العلامات المحفوظة واستيرادها.',
    'تحسينات في البحث ودقّة النتائج.',
