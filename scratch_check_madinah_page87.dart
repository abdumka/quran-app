...
void main() async {
  var url = Uri.parse('http://api.alquran.cloud/v1/page/87/quran-uthmani');
  ...
  if (res.statusCode == 200) {
    ...
    print('Madinah Page 87 starts with: Surah ' + ayahs.first['surah']['number'].toString() + ' Ayah ' + ayahs.first['numberInSurah'].toString());
    ...
    for (int i = 0; i < flattened.length; i++) {
      ...
      if (pageObj['page'] == 87) {
        ...
        print('JSON Page 87 starts with: Surah ' + ayahsJson.first['surah'].toString() + ' Ayah ' + ayahsJson.first['ayah'].toString());
        break;
      }
    }
  } else {
