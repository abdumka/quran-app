...
class AudioService {
  ...
  /// Subscription for playback progress tracking.
  ...
  /// Cycle through repeat modes: off → infinite → count(3) → count(5) → count(10) → off
